...
def training_data_formatter_digit():
  items = bayes.loadDataFile("/Users/aarti/ai_pa2/data/digitdata/trainingimages",5000,28,28)
  labels = bayes.loadLabelsFile("/Users/aarti/ai_pa2/data/digitdata/traininglabels",5000)
...
def testing_data_formatter_digit():
  items = bayes.loadDataFile("/Users/aarti/ai_pa2/data/digitdata/testimages",1000,28,28)
  labels = bayes.loadLabelsFile("/Users/aarti/ai_pa2/data/digitdata/testlabels",1000)
  output = [[0]*50 for _ in range(1000)]
...
# Load data
training_data = training_data_formatter_digit()
testing_data = testing_data_formatter_digit()
...
def training(percent):
  training_data_old = training_data_formatter_digit()
...
if __name__ == '__main__':
  ...
  ''' pick a number between 0 and 999 '''
  # demo(100)
